...
public class JavaParser implements Comparator<JavaParser>, Serializable{
    ...
    private int incidentCT;
    private int requestCT;
    ...
    public int getIncidentCT() {
        return incidentCT;
    }

    public void setIncidentCT(int incidentCT) {
        this.incidentCT = incidentCT;
    }
    ...
    public void setRequestCT(int requestCT) {
  ...
  */
  ...
  public void updateDocListStruct(String new_ID){
      ...
      Collections.sort(this.docListStruct, documentID1.DocIDComparator);
